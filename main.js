...
let toggleCamera = async ()=>{
  ...
  if(videoTrack.enabled){
    ...
    document.getElementById("camera-btn").style.backgroundColor = "rgb(233,80,80)"
  }else {
...
let toggleMic = async ()=>{
  ...
  if(audioTrack.enabled){
    ...
    document.getElementById("mic-btn").style.backgroundColor = "rgb(233,80,80)"
  }else {
...
// APP ID : 8891e61e4ff64e5dbb25e2ab6cd85ae6
